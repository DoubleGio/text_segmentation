...
def pk(ref: str, hyp: str, k: Optional[int] = None, boundary="1"):
    """
...
def windowdiff(ref: str, hyp: str, k: Optional[int] = None, boundary="1"):
    """
    ...
    wd = 0
    for i in range(len(ref) - k + 1):
        wd += abs(ref[i : i + k].count(boundary) - hyp[i : i + k].count(boundary))
